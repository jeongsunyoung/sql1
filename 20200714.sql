...
v_emp view는 pc22계정이 hr 계정에게 select 권한을 주었기 때문에
정상적으로 조회 가능
SELECT *
FROM pc22.v_emp;
...
view는 SQL 이기 때문에 조인된 결과나, 그룹함수를 적용하여 행의 건수가
...
FROM dual;
-- CURRVAL has been selected before sequence NEXTVAL
...
emp테이블에 primary key 제약조건을 생성하고 나서 변경된 점
